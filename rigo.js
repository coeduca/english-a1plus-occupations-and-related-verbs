...
(function () {
  ...
  const HINT_MESSAGES = [
    ...
    { text: "Confía en tu primera idea", grade: null, emotion: 'happy' },
    { text: "¿Ya intentaste? ¡Tú puedes!", grade: null, emotion: 'excited' },
    { text: "Shhh no le digas al teacher Eliseo, pero el pasado de fly es flew", grade: null, emotion: 'sneaky' },
    ...
    { text: "El inglés es como yo: bonito", grade: null, emotion: 'thinking' },
    { text: "Yo solo soy un camaleón, no un traductor", grade: null, emotion: 'sad' },
    { text: "Mejor pregúntale al Wilmer", grade: ["Segundo Año"], emotion: 'sneaky' },
    { text: "Esta pregunta la sabe hasta mi abuela", grade: null, emotion: 'sneaky' },
    { text: "Demérito por tocarme sin permiso", grade: null, emotion: 'angry' },
